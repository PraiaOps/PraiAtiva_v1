-- Script para adicionar apenas as 11 novas atividades sem remover as existentes
...
-- PASSO 2: Inserir apenas as 11 atividades novas do print (sem remover as existentes)
...
-- PASSO 3: Verificar todas as atividades do usuário (antigas + novas)
SELECT 
    a.id,
    a.location_name,
    a.title,
