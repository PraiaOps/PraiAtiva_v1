-- Script para adicionar as 4 atividades de vela
...
-- PASSO 2: Adicionar as 4 atividades de vela
...
-- PASSO 3: Verificar todas as atividades de vela
SELECT 
    a.id,
    a.location_name,
    a.title,
...
-- PASSO 4: Verificar total de atividades por tipo
SELECT 
    a.title,
    COUNT(*) as total
FROM public.activities a
